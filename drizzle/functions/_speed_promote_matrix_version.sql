...
-- Last extracted: 2026-05-09T14:17:01.514Z
...
END;
$function$;
COMMENT ON FUNCTION public._speed_promote_matrix_version(p_version_id integer) IS
...
GRANT EXECUTE ON FUNCTION public._speed_promote_matrix_version(p_version_id integer) TO PUBLIC;
GRANT EXECUTE ON FUNCTION public._speed_promote_matrix_version(p_version_id integer) TO sooqadmin;