-- Sprint 3 P1 fix (mig 0047): explicit 1m branch in payout cap check.
-- Body otherwise byte-equal to canonical post-0046 (CLV + 1m duration accept).
...
BEGIN
  ...
  IF v_market.duration::TEXT = '1m' THEN
