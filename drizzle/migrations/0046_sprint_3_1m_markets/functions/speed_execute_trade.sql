-- Sprint 3 (mig 0046): accepts '1m' duration
-- Body byte-equal to canonical post-0044 (CLV shading) except duration check
-- adds '1m' to the allowed list. 1h stays in the list so legacy 1h positions
-- can still cash out / settle (existing markets, drained queue).
