-- Sprint 1 Phase 2C (mig 0051): speed_execute_trade calls
-- _speed_max_stake_for_offered with new (asset, duration, offered_prob)
-- signature.
--
-- Body otherwise byte-equal to canonical post-0050 (Phase 2B trade reads).
