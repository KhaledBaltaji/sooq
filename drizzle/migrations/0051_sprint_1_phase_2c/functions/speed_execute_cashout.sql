-- Sprint 1 Phase 2C (mig 0051): speed_execute_cashout reads cashout-side
...
--
-- Also updates the _speed_cashout_margin call to new (asset, duration, ...)
-- signature.
--
-- Pattern: SELECT * INTO v_mc once at RPC entry; COALESCE chains everywhere.
