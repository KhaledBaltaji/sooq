-- Sprint 1 Phase 2A (mig 0049): soft_block_threshold reads per (asset, duration)
-- from speed_market_config, falling back to global fee_config.
--
-- Why: 1m markets need soft_block 0.85 (launch tax); gold needs 0.92.
-- Pre-0049 this helper read the global fee_config.speed_entry_soft_block_threshold
-- which is 0.95 across all markets. Per-market activation was blocked by
-- this read.
--
-- Body byte-equal to canonical post-0046 except the soft-block threshold
-- read at line 144.
