-- Sprint 0.6: speed_roll_markets only opens 5m markets going forward.
--
-- Founder decision per Phase 4 plan: 1h volume too low for matrix qualification;
-- strip the duration. Trade and cashout RPCs still accept 1h durations so that
-- existing open 1h positions can resolve normally.
--
-- Body byte-equal to canonical 0020 except for v_durations array.
