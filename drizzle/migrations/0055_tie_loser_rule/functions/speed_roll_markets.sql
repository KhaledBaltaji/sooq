-- ============================================================================
-- speed_roll_markets — mig 0055 update
-- ============================================================================
--
-- Identical to the 0020 canonical, with two changes:
--   1. After deciding (asset, duration), read tie_loser_rule_enabled from
--      speed_market_config and stamp it onto the new market row as
--      tie_loser_rule_active. This is the snapshot-at-open behavior —
--      markets carry their own settlement rule for life.
--   2. INSERT now includes the tie_loser_rule_active column.
--
-- Everything else (master kill, oracle freshness, 1m/GOLD gating, trading
-- hours, deferred boundary handling) is byte-equivalent to the prior
-- version.
