-- Sprint 4 Phase 5A (mig 0052): speed_execute_cashout reads per-asset
-- oracle_stale_seconds from speed_asset_config (BTC stays 2s, gold gets
-- 30s for thin PAXG bookticker windows).
--
