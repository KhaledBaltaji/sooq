-- ============================================================
-- 171: Fix execute_trade price alerts column name
--
-- Migration 169 re-introduced "triggered" instead of "is_triggered"
-- in the price alerts UPDATE. This migration rewrites the function
