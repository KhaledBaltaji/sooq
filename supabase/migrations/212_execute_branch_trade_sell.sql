-- ============================================================
-- 212: S2 Branch System — execute_branch_trade sell extension
--
-- Extends execute_branch_trade with the sell/cash-out path.
-- Checks: cash_out_enabled, branch pool sufficiency, exit fee.
-- Recreates the full function (buy + sell).
-- ============================================================
...
BEGIN
  ...
  IF p_amount IS NOT NULL AND p_amount > 0 THEN
    -- ═══════════════════════════════════════════
    -- BUY PATH (unchanged from migration 211)
    -- ═══════════════════════════════════════════
    ...
    -- Solvency gate (pre-trade projection)
  ...
  ELSIF p_shares_to_sell IS NOT NULL AND p_shares_to_sell > 0 THEN
    -- ═══════════════════════════════════════════
    -- SELL PATH (new in migration 212)
    -- ═══════════════════════════════════════════
