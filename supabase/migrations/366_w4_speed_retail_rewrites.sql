-- ============================================================================
-- 366_w4_speed_retail_rewrites.sql
--
-- W4 — Sooq rebuild plan (~/.claude/plans/oh-my-how-much-giggly-crystal.md)
--
-- Rewrites the three speed RPCs as retail-only, closing the "speed broken
-- mid-strip" window opened in W2/W3:
--   - speed_execute_trade
--   - speed_execute_cashout
--   - speed_resolve_market
--
-- Branch routing, speed_pool_ledger writes, speed_branches lookups, and the
-- pay_speed_trade_commissions call are all gone. Variance flows through
-- users.balance_usd + transactions ledger only. The user is the counterparty;
-- house P&L is derivable by aggregating speed_stake / speed_cashout /
-- speed_payout / speed_refund transaction types.
--
-- Also drops `branch_id` column from `speed_settlements` (missed in 365).
-- ============================================================================

set check_function_bodies = off;

-- ============================================================================
-- 1) Drop branch_id column from speed_settlements
-- ============================================================================
ALTER TABLE public.speed_settlements DROP COLUMN IF EXISTS branch_id;

-- ============================================================================
-- 2) speed_execute_trade — retail-only
-- ============================================================================
