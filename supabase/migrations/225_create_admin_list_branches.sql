-- ============================================================
-- 225: Create admin_list_branches() function
--
-- Migration 223 was originally applied as a VIEW on staging.
-- Migration 224 dropped that view. This migration creates the
-- correct SECURITY DEFINER function with admin auth checks.
--
-- On fresh databases (after reset), 223 already creates this
-- function, so we use CREATE OR REPLACE to be idempotent.
-- ============================================================
