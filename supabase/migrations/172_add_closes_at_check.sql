-- ============================================================
-- 172: Re-add closes_at safety check to execute_trade
--
-- The closes_at time check was in the original execute_trade (migration 110)
-- but was lost during function rewrites. This is a safety net: even if the
-- cron job hasn't flipped status to 'closed' yet, trades should be rejected
-- once closes_at has passed.
-- ============================================================
