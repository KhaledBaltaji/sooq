-- 127_fn_record_revenue_v2.sql — Updated record_revenue for NGR commission model
-- Changes from v1 (migration 112):
--   1. Removed p_total_commissions parameter — queries referral_commissions directly
--   2. This ensures correct total including both trade-time and resolution-time commissions
...
BEGIN
  ...
  -- [CHANGED] Query total commissions from referral_commissions (both trade + resolution)
