-- 141_fix_trigger_bypass_correct.sql
-- Fix migration 140 which used wrong column names.
-- This re-creates execute_trade and resolve_market with the EXACT original
-- function bodies from migrations 132 and 134, only adding the trigger bypass.

-- ============================================================
-- execute_trade — exact copy of 132 + trigger bypass at top
-- ============================================================
...
DECLARE
  ...
  v_chain UUID[];
BEGIN
  -- [FIX] Enable trigger bypass so balance_usd updates don't get blocked
...
-- ============================================================
-- resolve_market — exact copy of 134 + trigger bypass at top
-- ============================================================
