-- Migration 236: Restore sell path in execute_branch_trade
-- Migration 233 rewrote the function with BUY-ONLY, wiping the sell path from migration 212.
-- Migration 235 attempted to fix side/direction columns but also lacked the sell path.
...
BEGIN
  ...
  IF p_amount IS NOT NULL AND p_amount > 0 THEN
    ...
    -- Payback sweep: SOOQ fee is senior, sweep ceiling is gross minus fee
